...
class OptionCatalogRegistryTest {
    ...
    void resolvesStaticOptions() {
        FieldDefinition definition = new FieldDefinition(
                ...
                java.util.List.<ValidationDefinition>of(),
                java.util.List.<CrossFieldValidationDefinition>of(),
                new SecurityDefinition("", "", java.util.List.of(), false),
                0,
                1,
                1);
